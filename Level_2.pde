...
public class Level_2 {
  ...
  public Level_2(String _title, boolean _campaign) {  
    title = _title;
    campaign = _campaign;
  ...
  public void act() {
    ...
    text("Punten: " + puntenLevel_2, 320, 860);
