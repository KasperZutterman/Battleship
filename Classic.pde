...
public class Classic {
  ...
  *  deze methode staat in voor de schoten die uitgevoerd worden door de speler in de classic
  ...
  /*
   *  Deze methode staat in voor het hoveren en vuren van een bom
   */
  public void bomVuren(int rij, int kol) {
    if (bomHover) {
    ...
    if (mousePressed) {
      bomHover = false; //als geklikt wordt moet de hoverfunctie even stoppen
      ...
      bomHover = true; //er de bom gezet is moet de hoverfunctie weer werken
    }
  }
}
