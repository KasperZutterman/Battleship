...
public class Level_3 {
  ...
  public Level_3(String _title, boolean _campaign) {  
    title = _title;
    campaign = _campaign;
  ...
  public void act() {
    ...
    text("Punten: " + puntenLevel_3, 320, 860);
